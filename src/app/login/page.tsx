        ...
        <Card className="glass p-6">
          ...
          {step === "phone" && (
            <div className="space-y-4">
              ...
              <Button size="xl" className="w-full bg-foreground text-background hover:bg-foreground/90" onClick={handlePhoneSubmit} disabled={isLoading || phone.length < 10}>
          ...
          {step === "name" && (
            <div className="space-y-4">
              ...
              {error && <p className="text-[13px] text-destructive text-center">{error}</p>}
              <Button size="xl" className="w-full bg-foreground text-background hover:bg-foreground/90" onClick={handleNameSubmit} disabled={isLoading}>
