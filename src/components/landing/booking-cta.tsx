        ...
        <div className="mx-auto max-w-lg rounded-[var(--radius-booking-cta)] border border-[var(--booking-cta-border)] bg-[var(--booking-cta-bg)] p-4 shadow-card">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-0.5 max-w-[280px] text-small leading-6 text-muted-foreground">
          ...
          <button
            ...
            className="mt-4 flex min-h-[48px] w-full items-center justify-between rounded-[var(--radius-booking-item)] bg-foreground px-4 text-body font-bold text-background shadow-xs transition-[background-color,transform] duration-200 hover:bg-foreground/85 active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
