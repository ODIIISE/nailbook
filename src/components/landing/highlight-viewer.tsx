      ...
      <div className="absolute bottom-6 left-0 right-0 z-20 flex flex-col items-center gap-3">
        {highlight.service_id && (
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-black text-caption font-bold shadow-lg active:scale-[0.97] transition-transform"
          >
