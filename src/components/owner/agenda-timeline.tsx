        ...
        <div className="relative" style={{ height: totalHeight }}>
          ...
          {bookings.map((booking) => {
            ...
            return (
              ...
              >
                <div className="h-full rounded-lg bg-rose/10 border border-rose/30 p-2 hover:bg-rose/15 transition-colors overflow-hidden">
                  <div className="flex items-center gap-1 mb-0.5">
                    <User className="h-3 w-3 text-rose shrink-0" />
                    <span className="text-xs font-semibold text-rose truncate">
                      {booking.customer_name}
                    </span>
                  </div>
                  <p className="text-[10px] text-rose/70 truncate">
                    {booking.service?.name}
                  </p>
                  {style.height > 40 && (
                    <p className="text-[10px] text-rose/50 mt-0.5">
