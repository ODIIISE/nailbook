...
ALTER TABLE salon_info ADD COLUMN IF NOT EXISTS homepage_kicker TEXT DEFAULT 'NAIL · CARE · RITUAL';
...
ALTER TABLE salons ADD COLUMN IF NOT EXISTS homepage_kicker TEXT DEFAULT 'NAIL · CARE · RITUAL';
